...
- [Standardize lint, Commitlint, and graph automation](../../wiki/journal/2026-08-22-standardize-lint-commitlint-and-graph-automation.md) → [Component architecture — Design History](../../wiki/topics/component-architecture.md)
...
- [Cross-repository lint, Commitlint, and graph standardization](../../wiki/plans/2026-08-22-cross-repository-lint-commitlint-and-graph-standardization.md) → [Component architecture — Design History](../../wiki/topics/component-architecture.md)
- [Cross-repository lint, Commitlint, and graph standardization](../../wiki/plans/2026-08-22-cross-repository-lint-commitlint-and-graph-standardization.md) → [Knowledge graph & wiki automation — Design History](../../wiki/topics/graph-wiki-subsystem.md)
- [Cross-repository lint, Commitlint, and graph standardization](../../wiki/plans/2026-08-22-cross-repository-lint-commitlint-and-graph-standardization.md) → [Package distribution — Design History](../../wiki/topics/package-distribution.md)
...
- [Figma library — Design History](../../wiki/topics/figma-code-connect.md) → [REVIEW-STANDARDS.md](../../figma/REVIEW-STANDARDS.md)
...
- [Knowledge graph & wiki automation — Design History](../../wiki/topics/graph-wiki-subsystem.md) → [pre-push](../../.husky/pre-push)
...
- [Knowledge graph & wiki automation — Design History](../../wiki/topics/graph-wiki-subsystem.md) → [CLAUDE.md](../../CLAUDE.md)
