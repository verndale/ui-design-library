...
Totals: 10 implemented, 5 partial (15 plans).

## Plans

| Date | Plan | Status | Evidence | Topics |
| --- | --- | --- | --- | --- |
| 2026-08-19 | [Official source-parity audit and remediation](2026-08-19-source-parity-audit-and-remediation.md) | partial | [issue #58](https://github.com/verndale/ui-design-library/issues/58), [issue #62](https://github.com/verndale/ui-design-library/issues/62), 21-component private audit, Carousel worktree/Figma remediation; four dedicated remediations pending, [PR #64](https://github.com/verndale/ui-design-library/pull/64) | figma-code-connect |
