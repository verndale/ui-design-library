...
| Button | `server` | `button` | `button.keyboard.activation` (2.1.1, 2.5.8, 4.1.2)<br>`button.focus.visible` (2.4.7, 2.4.11)<br>`button.icons.decorative` (1.1.1)<br>`button.icon-only.name` (1.1.1, 2.5.8, 4.1.2) | `accessible-copy`<br>`token-contrast`<br>`safe-class-overrides`<br>`complete-page-assistive-technology-testing` |
...
| In-page navigation | `hybrid` | `modal-dialog` | `in-page-navigation-modal.open-dismiss` (2.1.1, 2.5.8, 4.1.2)<br>`in-page-navigation-modal.focus.containment` (2.1.2, 2.4.3, 2.4.11)<br>`in-page-navigation-modal.focus.restoration` (2.4.3)<br>`in-page-navigation-modal.keyboard.escape` (2.1.1, 2.1.2)<br>`in-page-navigation-modal.outside-dismiss` (2.1.1, 2.5.8)<br>`in-page-navigation-modal.swipe.threshold` (2.5.1, 2.5.7, 2.5.8)<br>`in-page-navigation-modal.swipe.scroll` (2.5.1, 2.5.7)<br>`in-page-navigation-modal.responsive.hidden` (2.4.3)<br>`in-page-navigation-modal.motion.reduced` (2.3.3)<br>`in-page-navigation-modal.semantics` (1.3.1, 2.4.1, 4.1.2) | `accessible-copy`<br>`heading-context`<br>`landmark-context`<br>`token-contrast`<br>`safe-class-overrides`<br>`complete-page-assistive-technology-testing` |
...
| Slider | `client` | `slider` | `slider.keyboard.native` (2.1.1, 2.5.8, 4.1.2)<br>`slider.value.announced` (4.1.2)<br>`slider.description.valid` (1.3.1, 4.1.2)<br>`slider.form.native` (1.3.1, 4.1.2)<br>`slider.form.reset` (4.1.2)<br>`slider.form.controlled` (4.1.2)<br>`slider.form.disabled` (4.1.2)<br>`slider.form.empty` (4.1.2) | `accessible-copy`<br>`token-contrast`<br>`safe-class-overrides`<br>`complete-page-assistive-technology-testing` |
...
| Tabs | `client` | `tabs` | `tabs.keyboard.roving` (2.1.1, 2.4.3, 2.4.11, 2.5.8)<br>`tabs.keyboard.vertical` (2.1.1, 2.4.3)<br>`tabs.state.selection` (1.3.1, 4.1.2)<br>`tabs.presentation.visual` (1.3.1, 1.4.11)<br>`tabs.state.controlled` (4.1.2) | `accessible-copy`<br>`token-contrast`<br>`safe-class-overrides`<br>`complete-page-assistive-technology-testing` |
| Tabs | `client` | `tabs` | `tabs-native-select.responsive.hidden` (2.4.3)<br>`tabs-native-select.responsive.focus` (2.4.3, 2.4.11)<br>`tabs-native-select.semantics` (1.3.1, 2.4.1, 3.3.2, 4.1.2)<br>`tabs-native-select.state.controlled` (4.1.2)<br>`tabs-native-select.state.selection` (1.3.1, 4.1.2) | `accessible-copy`<br>`token-contrast`<br>`safe-class-overrides`<br>`complete-page-assistive-technology-testing` |
