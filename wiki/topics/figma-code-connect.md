...
- Default and single-implementation master names equal the ui-design-brain canonical. Structural alternate imports use `Canonical / Variant label`; contextual presentations of one import, including the two stable Button sets, retain their published names and identities.
