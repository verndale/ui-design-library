...
| --- | --- | --- | --- | --- |
| 2026-08-13 | [Realization-First Reuse with WCAG 2.2 AA Accessibility](2026-08-13-realization-first-reuse-wcag-22-aa.md) | implemented | [issue #37](https://github.com/verndale/ui-design-library/issues/37), `pnpm test`, `pnpm verify`, [PR #38](https://github.com/verndale/ui-design-library/pull/38) | component-architecture, package-distribution, story-testing |
